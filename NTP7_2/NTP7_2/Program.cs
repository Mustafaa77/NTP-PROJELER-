    ...
    public class Elektronik : Urun
    {
        ...
        class Program
        {
            static void Main(string[] args)
            {
                ...
                Yayinci Mustafa = new Yayinci();

                // Aboneler oluşturuluyor
                Abone abone1 = new Abone("Yusuf");
                Abone abone2 = new Abone("İnci");
                Abone abone3 = new Abone("Seda");

                // Aboneler yayıncıya ekleniyor
                Mustafa.AboneEkle(abone1);
                Mustafa.AboneEkle(abone2);
                Mustafa.AboneEkle(abone3);

                // Yayıncı bir bildirim gönderiyor
                Mustafa.BildirimGonder("Yeni bir makale yayınlandı!");

                // Bir abone çıkarılıyor
                Mustafa.AboneCikar(abone2);

                // Yayıncı başka bir bildirim gönderiyor
                Mustafa.BildirimGonder("Yarın canlı yayın var!");
                Console.ReadLine();
            }
        }
